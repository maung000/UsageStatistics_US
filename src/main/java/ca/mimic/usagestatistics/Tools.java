...
//            Tools.USLog("Last package same as current top, skipping! [" + lollipopTaskInfo.packageName + "]");
        ...
        if (bRunner == null) {
            Tools.USLog("Couldn't find previous task [" + lollipopTaskInfo.packageName + "]");
        } else {
        ...
        lollipopTaskInfo.lastDay = df.format(new Date(aRunner.getLastTimeUsed()));

        Tools.USLog("New [" + lollipopTaskInfo.packageName + "] old [" + lollipopTaskInfo.lastPackageName + "] old FG delta: " + lollipopTaskInfo.timeInFGDelta);
    ...
    protected static class TaskComparator implements Comparator<TaskInfoOrder> {
        ...
        public TaskComparator (String type, int weight, int num){
            ...
            USLog("num: " + num + " calNum: " + calNum + " baseRecency: " + baseRecency + " numToCompare: " + numToCompare);
    ...
    protected ResolveInfo cachedImageResolveInfo(Context mContext, String packageName) {
        ...
        try {
            ...
            Tools.USLog("bad PackageName: " + packageName + " -- deleting!");
    ...
    protected synchronized static ArrayList<Tools.TaskInfo> buildTaskList(Context context, TasksDataSource db,
        ...
        Tools.USLog("buildTaskList queueSize: " + queueSize + " weighted: " + weighted + " taskList: " + taskList + " pinnedApps: " + pinnedApps.size());
        ...
        if (pinnedList.size() > 0) {
            if (pinnedPlacement == Settings.PINNED_PLACEMENT_LEFT) {
                ...
                try {
                    ...
                    Tools.USLog("outofbounds count: " + count + " index: " + index + ": " + e);
